...
# with heavy ball momentum, for a beta value of 0.5
# To run this type "python ConstMomentumBeta0.5.py"
# You can pipe the output as follows
# "python ConstMomentumBeta0.5.py > outputs/imsaves/ConstantMomentumBeta0.5/ConstantMomentumBeta0.5Log.txt"
...
if __name__ == "__main__":
    ...
    numStates = 25
    numFeatures = 10
    filesLocation = "Outputs/imSaves/ConstantMomentumBeta0.5/"
    ...
    for iter in range(10):
        ...
        for momentum in momentumChoices:
            ...
            #
            simName = str(iter + 1) + "Long Stochastic CurvatureStep TP with Constant Momentum, Beta 0.5"
            chartTitle = "Errors for Long Stochastic CurvatureStep TP with Constant Momentum, Beta 0.5"
