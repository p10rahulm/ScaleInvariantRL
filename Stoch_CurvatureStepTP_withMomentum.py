...
# This file is used to run curvature-step Total Projections in the stochastic case with momentum
# To run this type "python Stoch_CurvatureStepTP_withMomentum.py"
# You can pipe the output as follows
# "python Stoch_CurvatureStepTP_withMomentum.py > outputs/imsaves/LongS_CurvatureStepTP_withMomentum/LongS_CurvatureStepTP_withMomentumLog.txt"

def runTP_Sims(A_input, b_input, x_input, probDist, maxIters, errorType=0, utType="Reg", tpType="Reg",momentumMult=0.1):
...
if __name__ == "__main__":
    ...
    numStates = 25
    numFeatures = 10
    filesLocation = "Outputs/imSaves/LongS_CurvatureStepTP_withMomentum/"
    ...
    for iter in range(10):
        ...
        for momentum in momentumChoices:
            ...
            simName = str(iter + 1) + "Long Stochastic CurvatureStep TP with Momentum = " + str(momentum)
            chartTitle = "Errors for Long Stochastic CurvatureStep TP with Momentum = " + str(momentum)
