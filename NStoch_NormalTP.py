...
# This file is used to run Plain Total Projections in the non-stochastic case
# To run this type "python NStoch_NormalTP.py"
# You can pipe the output as follows
# "python NStoch_NormalTP.py > outputs/imsaves/LongNS_PlainTP/LongNS_PlainTPLog.txt"
...
if __name__ == "__main__":
    ...
    numStates = 100
    numFeatures = 30
    filesLocation = "Outputs/imSaves/LongNS_PlainTP/"
    ...
    for iter in range(10):
        ...
        simName = str(iter + 1) + "Long Non Stochastic Plain TP"
        chartTitle = "Errors for Long Non Stochastic Plain TP"
