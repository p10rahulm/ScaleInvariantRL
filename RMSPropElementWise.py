...
# This file is used to run RMSProp, where division is done elementwise
# To run this type "python RMSPropElementWise.py"
# You can pipe the output as follows "python RMSPropElementWise.py > outputs/imsaves/RMSProp/RMSPropLog.txt"
...
def RMSProp(A_input, b_input, x_input, probDist, maxIters, errorType=0, utType="Reg", tpType="Reg",momentumMult=0.1):
    ...
    while iters < maxIters:
        ...
        Mean_Squared_gradient = beta * Mean_Squared_gradient + (1 - beta) * dTP1**2
