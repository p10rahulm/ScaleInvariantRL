...
def runTP_Sims(A_input, b_input, x_input, probDist, maxIters, errorType=0, utType="Reg", tpType="Reg"):
    ...
    while iters < maxIters:
        ...
        Curvature = (rprime_t_norm**3/(rprime_t_norm**2*rdoubleprime_t_norm**2 - (np.dot(rprime_t,rdoubleprime_t))**2)**0.5)**-1
        ...
        # alpha = 1 / kappa
        x_proc = x_proc + alpha * (rprime_t)/utils.twoNorm(rprime_t)
...
if __name__ == "__main__":
    ...
    # numStates = 30
    # numFeatures = 10
    filesLocation = "Outputs/imSaves/LongNS_CurvatureStep/"
