...
# To run this type "python Stoch_CurvatureStepTP.py"
# You can pipe the output as follows
# "python Stoch_CurvatureStepTP.py > outputs/imsaves/LongS_CurvatureStepTP/LongS_CurvatureStepTPLog.txt"
...
def runTP_Sims(A_input, b_input, x_input, probDist, maxIters, errorType=0, utType="Reg", tpType="Reg"):
    ...
    while iters < maxIters:
        ...
        x_proc = x_proc + alpha * radius* (dTP1)
...
if __name__ == "__main__":
    ...
    numStates = 25
    numFeatures = 10
    filesLocation = "Outputs/imSaves/LongS_CurvatureStepTP/"
    ...
    for iter in range(10):
        ...
        simName = str(iter + 1) + "Long Stochastic CurvatureStep TP"
        chartTitle = "Errors for Long Stochastic CurvatureStep TP"
